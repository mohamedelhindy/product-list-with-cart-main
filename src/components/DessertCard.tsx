        ...
        <div>
          {inCart ? (
            <div className="w-fit flex gap-11 bg-[hsl(14_86%_42%)] justify-center items-center px-3 py-1.5 rounded-full transition-all duration-300">
              <div className="flex items-center justify-center border border-white py-2 px-1 rounded-full">
                <img
              ...
              <div className="flex items-center justify-center border border-white py-1 px-1 rounded-full">
                <img
